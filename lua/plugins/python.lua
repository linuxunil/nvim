-- lua/plugins/python.lua (Optimized - removed redundant plugins)
return {
  ...
  -- Python REPL
  {
    ...
    keys = {
      ...
      { "<leader>pS", function() require("iron.core").send_file() end,               desc = "Send file to REPL" },
  ...
  -- Note: Removed vim-python-pep8-indent and vim-pythonsense
  -- LSP handles indentation, mini.ai + treesitter handles text objects
}
